...
class _addContact extends State<AddContact> {
  ...
  bool _primaryValidator = true;
  bool _seconderyValidator = true;
  bool _cellValidator = true;
  bool _emailValidator = true;
  bool _streetValidator = true;
  bool _cityValidator = true;
  bool _stateValidator = true;
  bool _zipValidator = true;
  ...
  TextEditingController _seconderyPhoneController = new TextEditingController();
  ...
  Future<String> makeRequest() async {
    Map data = {
      ...
      'authorization': 'bearer zuK7VbVjxN2g_5wLZx0HG8eahWrOSeQjuldzIzwNK4hX-A6mfxZ-Q81jhJZwn6-BcPYQM9hENBekI_V_aEJeji4fsp8_fCle0Z7EdZk9SiB9jIpZSphL-x98KlxSBAkxuqhu2oowC1nK5PK5QhB_QTOCng1B0KnBKznTPoyoUt_2qA-OHrOnqrE9T8LpqHfKZLUOykTttXZm-rBJjyxj2PWDEZGnufMsA8cieEtOxcD_XPUnl6Ec41ykPzM7rhj_tOuapRxZsyEX1UvR0zesz8QN5G5TVi5Khn8-PpJSqPLINR293PlOIMbtTd_DlgjUvQq_FrbSDk21GUw9X-zeQBYHG5hRdmXXfu6nodcd32Z6hTAEDhABhhrsZkvGcxMuRjpdO9duvGfYNgPwdSaVjA',
      'FirstName': '${_firstNameController.text}',
      'LastName': '${_lastNameController.text}',
      'BusinessName': '${_businessTypeController.text}',
      'Type': 'Test',
      'PrimaryPhone': '${_primaryPhoneController.text}',
      'SecondaryPhone': '${_seconderyPhoneController.text}',
                  ...
                  Expanded(
                    ...
                    child: TextField(
                      ...
                      decoration: new InputDecoration(
                        ...
                        errorText: _seconderyPhoneController != null ? null : "* Required",
                        errorStyle: customTextFieldErrorStyle(),
                        hintStyle: customHintStyle(),
                        isDense: true,
                      ),
