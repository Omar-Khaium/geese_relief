                ...
                children: <Widget>[
                  Align(
                    ...
                    child: Row(
                      children: <Widget>[
                        CustomBackButton(
                          onTap: () => widget.backToCustomerDetailsFromEstimate(
                              widget.customer),
                        ),
                        SizedBox(
                          width: 16,
                          ...
                          children: <Widget>[
                            Row(
                              children: <Widget>[
                                ...
                                Text(
                                  _productList[index].quantity.toString(),
                                  style: listTextStyle(),
                                )
                              ],
                            ),
                      ...
                      children: <Widget>[
                                  ...
                                  Container(
                                    ...
                                    child: DropdownButtonHideUnderline(
                                      child: DropdownButton<String>(
                                        ...
                                        value: _DiscountTypeSelectedValue,
                                      ),
                                    ),
                                  ),
                                  SizedBox(
                                  ...
                                  Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: new InputDecoration(
                                        ...
                                        hintText:
                                            _DiscountTypeSelectedValue == "Cash"
                                                ? "Amount"
                                                : "Percentage",
                        ...
                        Row(
                          ...
                          children: <Widget>[
                            ...
                            Text("\$ ${estimateTaxTotal.toStringAsFixed(2)}"),
                          ],
                        ),
                        SizedBox(
                          height: 4,
                              ...
                              child: Container(
                                ...
                                child: TypeAheadField(
                                  ...
                                  onSuggestionSelected: (suggestion) {
                                    _productNameController.text =
                                        suggestion['EquipmentName'].toString();
                                    _descriptionController.text =
                                        suggestion['EquipmentType'].toString();
                                    _quantityController.text = "1";
                                    _rateController.text =
                                        suggestion['RetailPrice'].toString();
