...
class NewUserUI extends StatefulWidget {
  @override
  _NewUserUIState createState() => _NewUserUIState();
}

class _NewUserUIState extends State<NewUserUI> {
                    ...
                    IconButton(
                      ...
                      onPressed: () => Navigator.of(context).push(
                        new MaterialPageRoute(
                          builder: (context) => UserAddressMapWidget(
